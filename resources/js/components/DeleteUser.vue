        ...
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            ...
            <Dialog>
                <DialogTrigger as-child>
                    <Button variant="destructive" class="cursor-pointer">Eliminar cuenta</Button>
                </DialogTrigger>
                <DialogContent>
                    <form class="space-y-6" @submit="deleteUser">
                        ...
                        <DialogFooter class="gap-2">
                            <DialogClose as-child>
                                <Button variant="secondary" @click="closeModal" class="cursor-pointer"> Cancelar </Button>
                            </DialogClose>

                            <Button type="submit" variant="destructive" :disabled="form.processing" class="cursor-pointer"> Eliminar cuenta </Button>
                        </DialogFooter>
                    </form>
                </DialogContent>
            </Dialog>
